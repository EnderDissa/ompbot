...
from utils import IgnoredList, VK, check_excel, create_excel
            ...
            if event.type == VkBotEventType.MESSAGE_EVENT:
                ...
                if pl:
                    ...
                    if type == "send":
                        ...
                        VK.editkb(peer_id=peer_id, cmid=conversation_message_id, type="sended", sender=sender, title=title)
                    elif type == "approve":
                        ...
                        VK.editkb(peer_id=peer_id, cmid=conversation_message_id, type="approved", sender=sender, title=title)
                    else:
                        continue
